...
const Banner = () => {
    return (
        <Container className="mt-4">
            <Row>
                <Col sm={12} md={6} lg={6} className="d-flex flex-column align-items-start justify-content-evenly">
                    ...
                    <Button className="rounded px-5" style={{ backgroundColor: "#F53838" }}>Get Started</Button>
                </Col>
                <Col sm={12} md={6} lg={6}>
